...
dmgbuild=""
version="4.6.6"
app_settings_file="/home/neo/git/wireshark-adfree/packaging/macosx/wireshark-app.dmgbuild"
dsym_settings_file="/home/neo/git/wireshark-adfree/packaging/macosx/wireshark-dsym.dmgbuild"
architecture=""
...
if lipo "$app_name.app/Contents/MacOS/$app_name" -verify_arch arm64 x86_64 ; then
	architecture=""
elif lipo "$app_name.app/Contents/MacOS/$app_name" -verify_arch arm64 ; then
	architecture=" Arm 64"
...
if [[ $app_name = Strato* ]] ; then
	version="0.9.6"
	app_settings_file="/home/neo/git/wireshark-adfree/packaging/macosx/stratoshark-app.dmgbuild"
	dsym_settings_file="/home/neo/git/wireshark-adfree/packaging/macosx/stratoshark-dsym.dmgbuild"
fi
