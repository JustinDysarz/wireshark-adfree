...
#define STRATOSHARK_VERSION "0.9.6"
...
#define HAVE_ZLIBNG 1
#define ZLIBNG_VERSION_STRING "2.3.3"

/* Define to use the minizip library */
#define HAVE_MINIZIP 1
#define MINIZIP_VERSION "1.3.2"
...
/* Whether the Lua library has a two-argument lua_resetthread(). */
/* #undef HAVE_TWO_ARGUMENT_LUA_RESETTHREAD */
